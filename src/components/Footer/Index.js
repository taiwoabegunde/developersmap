    ...
    render(){
        return (
            <div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="span3 offset1">
                                <h5>MORE INFO</h5>
                                <div><a href="https://twitter.com/taiwoabegunde" target="_target">Twitter</a></div>
                ...
                {/* Footer Ends */}
                <footer id="copyright">
                    Copyright © 2017 DevelopersMAP was created By <a href="https://twitter.com/taiwoabegunde">Taiwo Abegunde</a>. Linking Developers Together
                </footer>
            </div>
        )
    }

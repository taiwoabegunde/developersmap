                                ...
                                <Formsy.Form onValidSubmit={this.handleSubmit} onValid={this.enableButton}
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <MyInput className="form-group col-lg-6" name="username" title="Username"
                                                 placeholder="username e.g benjaminaiwo" validations="minLength:1"
                                                 validationError="Username is required."  />
                                        {/* Name Form Input */}
                                        <MyInput className="form-group col-lg-6" name="fullname" title="Name"
                                                 placeholder="fullname e.g Taiwo Abegunde" validations="minLength:1"
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <MyInput className="form-group col-lg-6" name="email" title="Email Address"
                                                 placeholder="email e.g taiwoabegunde@live.com" validations="isEmail"
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        <MyTextarea className="form-group col-lg-12"
                                            ...
                                            placeholder="e.g. Plot 15, Kudirat Adenekan Street, Isolo, Lagos, Nigeria"
